...
// Resolve a provider adapter by name. `openai-compat` (aliases: `compatible`,
// `custom`) yields a generic OpenAI-compatible adapter pointed at baseUrl — this is
// how Groq/Together/Ollama/vLLM/Gemini-compat backends are reached. Any other
